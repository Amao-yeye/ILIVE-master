...
#include "Basis/rgb_map/offline_map_recorder.hpp"
...
#include "Basis/meshing/MVS/Common.h"
#include "Basis/meshing/MVS/Image.h"
#include "Basis/meshing/MVS/PointCloud.h"
#include "Basis/meshing/MVS/Mesh.h"
#include "Basis/meshing/build_mesh.hpp"
...
int main( int argc, char **argv )
{
    ...
    // system( "clear" );
    printf_program( "ILIVE_meshing" );
    Common_tools::printf_software_version();
    ros::init( argc, argv, "ILIVE_meshing" );
